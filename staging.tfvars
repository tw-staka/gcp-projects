...
read_access_accounts = ["user:sethur@thoughtworks.com","user:johntan@thoughtworks.com"]
read_access_to_terraform_state_file = ["user:sethur@thoughtworks.com","user:johntan@thoughtworks.com"]